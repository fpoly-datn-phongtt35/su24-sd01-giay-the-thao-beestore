...
//thêm sản phẩm vào giỏ hàng
    ...
    public String addCart(@PathVariable("id") Long idChiTietSanPham,
        ...
        if(colorId == null  || sizeId == null) {
            ...
            redirectAttributes.addFlashAttribute("toastMessage", "Chọn đầy đủ màu sắc và Kích Thước");
...
//tiến hành thanh toán
    ...
    //hai phương thức đặt hàng ,thanh toán bằng tiền mặt và vpay
...
//sửa địa chỉ khách hàng
    ...
    //xóa địa chỉ khách hàng khi thanh toán
    @GetMapping("/checkout/xoakh/{id}")
    public String deleteDiaChicheckout(@PathVariable("id") Long id,
        ...
        // Lấy URL của trang trước (referer)
        String referer = request.getHeader("Referer");

        // Điều hướng lại trang trước khi xóa
    ...
    //thhanh toán xong hiện giao diện cảm ơn
    @GetMapping("/thankyou")
    public String b() {
